...
image = cv2.imread('wdg2.bmp', cv2.IMREAD_UNCHANGED )
...
image_eroded = cv2.erode(image_neg,kernel_circ,iterations=3)  #erosion image 3 times
...
image_eroded2 = cv2.erode(image_neg,kernel_rect,iterations=3)  #erosion image 3 times
