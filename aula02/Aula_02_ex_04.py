...
image = cv2.imread( sys.argv[1], cv2.IMREAD_UNCHANGED );
#image = cv2.imread( sys.argv[2], cv2.IMREAD_UNCHANGED );
...
#ireland-06-01.tif -- muitas zonas brancas mas tambem pretas
#ireland-06-02.tif -- pouco contraste 
#ireland-06-03.tif -- ba exposiçao e contraste
#ireland-06-04.tif -- boa exposiçao e contraste
#ireland-06-05.tif -- overexposed - grande qtd de pixeis brancos
#ireland-06-06.tif -- ok - nao tem gd qtd de pixeis brancos nem pretos
